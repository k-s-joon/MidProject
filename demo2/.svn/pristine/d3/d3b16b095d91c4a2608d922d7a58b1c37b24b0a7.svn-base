...
<div class="sidebar-navigation" >
		...
		<%} else if(memP==1){ %>
		<div class="logo">
			<a href=""><img src="./img/logo.png" style="width: 150px; margin: 0px 50px;"></a>
		</div>
		<nav>		
			<ul>
				...
				<a href="./report/reportlist"> <span class="rect"></span> <span class="circle"></span>신고사항</a>
			
				<a href="./member/membermanager"> <span class="rect"></span> <span class="circle"></span>블랙 리스트</a>
			</ul>
	</nav>	
		<%} %>
