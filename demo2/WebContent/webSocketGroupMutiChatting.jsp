		...
		<tr>
			<td style="vertical-align: top;">
				<div id="chatArea">
				    ...
				    <!-- 송신 메시지 텍스트박스 -->
				    <input type="text" id="messageText" size="40" onkeyup="if(window.event.keyCode==13){sendMessage()}" > <!-- onkeydown="sendMessage()" -->
				    <!-- 송신 버튼 -->
    ...
    <script type="text/javascript">
    	...
    	function connectting(){
    		if(userText.value.trim()==""){
				...
				//웹소켓 초기화
				webSocket = new WebSocket("ws://192.168.34.44/demo2/websocketGroupMultiChat.do");
