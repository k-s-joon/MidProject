...
<body>
  ...
  <table>
    ...
    <div class="card" style="width: 18rem; ">
        <img src="img/register.png" class="card-img-top" alt="register" height="250px" width="150px">
        <div class="card-body">
    ...
    <td>
    <div class="card" style="width: 18rem; ">
        <img src="img/revision.png" class="card-img-top" alt="..." height="230px">
        <div class="card-body">
...
<td>
    <div class="card" style="width: 18rem; ">
        <img src="img/카리나1.jpg" class="card-img-top" alt="...">
        <div class="card-body">
...
<tr>
    <td>
    <div class="card" style="width: 18rem; ">
        <img src="img/한소희1.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <td>
    <div class="card" style="width: 18rem; ">
        <img src="img/박성웅2.jpg"  style="height: 153px;" class="card-img-top" alt="...">
        <div class="card-body">
...
<td>
    <div class="card" style="width: 18rem; ">
        <img src="img/마동석2.jpg" style="height: 153px;" class="card-img-top" alt="...">
        <div class="card-body">
